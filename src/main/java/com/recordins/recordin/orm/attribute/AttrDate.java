...
public class AttrDate extends AttrLongPositive {

    /* Logger for console output */
    private static final Logger logger = LoggerFactory.getLogger(AttrDate.class);
     ...
     * representation.
     */
    public AttrDate() throws AttrException {
        this(LocalDateTime.now(ZoneOffset.UTC).toInstant(ZoneOffset.UTC).toEpochMilli());
        logger.trace("START AttrDate()");
        logger.trace("END AttrDate()");
    }

    /**
     * Initializes an instance object for date value representation.
     *
     * @param value {@code Long} representation of an {@link AttrDateTime}
     * @throws AttrException if given {@code Long} is not an
     *                       {@link AttrDate} representation or does not respect min and max
     *                       values.
     */
    public AttrDate(Long value) throws AttrException {
        logger.trace("START AttrDate(Long)");
    ...
    public AttrDate(JSONArray jsonArray) throws AttrException {
        logger.trace("START AttrDate(JSONArray)");
     ...
     * Initializes an instance object for date value representation.
     *
     * @param value {@code String} representation of an {@link AttrDate}
     * @throws AttrException if given {@code String} is not an
     *                       {@link AttrDate} representation or does not respect min and max
     *                       values.
     */
    public AttrDate(String value) throws AttrException {
        logger.trace("START AttrDate(Long)");
    ...
    /**
     * Returns corresponding {@code AttrDate} representation, for given
     ...
     *                               values.
     */
    public static AttrDate valueOf(String value) throws AttrException {
        logger.trace("START valueOf(String)");

        logger.trace("END valueOf()");
        return new AttrDate(value);
    }
    ...
    */
    ...
    /**
     * Compares current {@link AttrDate} value with {@link AttrDate}
    ...
    public int compareTo(Attr attr) {
        logger.trace("START compareTo(AttrDate)");
        ...
        return Long.compare(this.longValue, ((AttrDate) attr).longValue());
    }
    ...
    public boolean equals(Attr attr) {
        logger.trace("START equals(AttrDate)");
        ...
        return this.longValue == ((AttrDate) attr).longValue;
    }
